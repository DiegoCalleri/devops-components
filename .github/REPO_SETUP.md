...
gh repo edit DiegoCalleri/devops-components \
  --description "Reusable GitHub Actions workflows: build & push Docker images for Next.js, Node.js, and Go to GHCR/ECR/YCR" \
...
gh release create v1.0.0 --title "v1.0.0" --notes "Initial release: push-image workflow, build-and-push action, Next.js, Node.js, and Go Dockerfiles."
```
